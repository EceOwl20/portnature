...
const AlaCarteMain = () => {
  return (
      <section className="flex w-screen h-[70vh] items-start justify-between bg-white">
        <div className="flex flex-col w-full lg:w-[49%] items-center justify-center lg:gap-[30px] text-center lg:text-start ">
        ...
        <div className="hidden lg:flex flex-col w-[49%] items-center lg:items-start justify-center lg:gap-[30px] text-center lg:text-start">
        <img
            src={image}
            alt="img"
            width={image.width}
            height={image.height}
          />
          <p className="text-[15px] w-[90%] lg:w-[55%] text-black font-monserrat font-normal leading-[22.5px] lg:mt-[43px]">
