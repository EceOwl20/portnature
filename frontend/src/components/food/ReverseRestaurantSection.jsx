...
const ReverseRestaurantSection = ({image,header,text,span,link}) => {
  return (
    ...
    <div className='flex w-[100%] lg:w-[90%] flex-col-reverse lg:flex-row-reverse items-center justify-center gap-5 lg:gap-0'>
      <img src={image} alt='img' width={image.width} height={image.height} className='flex w-full sm:w-[95%] md:w-[90%] lg:w-[60%]'/>
      <div className='flex w-[90%] lg:w-[40%] items-center justify-center'>
          <div className='flex flex-col w-[95%] lg:w-[70%] items-center md:items-start justify-center text-center md:text-start gap-[18px] lg:gap-[30px] font-monserrat leading-[22.5px]'>
              ...
              <Link to={link} className='flex items-center justify-center py-[12px] w-[150px] border border-[#868686] bg-transparent hover:bg-customGray hover:text-white text-[14px] font-monserrat leading-normal text-center font-bold text-customGray'>More About</Link>
          </div>
      </div>
    </div>
  </section>
