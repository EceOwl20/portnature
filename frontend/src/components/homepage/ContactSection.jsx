        ...
        <div className='flex flex-col w-[100%] items-center justify-center text-center lg:items-start lg:text-start gap-[20px]'>
          ...
          <div className='grid grid-cols-2 lg:flex lg:flex-col w-[90%] items-center justify-center'>
            <div className='flex items-center justify-start w-[90%] gap-[7%]'>
              ...
              <p className='text-[12px] font-normal leading-[30px]'>+ 90 (242) 731 11 77</p>
            </div>
            <div className='flex items-center justify-start w-[90%] gap-[7%]'>
              <MessageSvg className="flex" width={21} height={17}/>
              <p className='text-[12px] font-normal leading-[30px]'>info@portnature.com.tr</p>
            </div>
            <div className='flex items-center justify-start w-[90%] gap-[7%]'>
              <PhoneSvg className="flex" width={18} height={19}/>
              <p className='text-[12px] font-normal leading-[30px]'>+ 90 (242) 731 07 07</p>
            </div>
            
            <div className='flex items-center justify-start w-[90%] gap-[7%]'>
              <WhatsappSvg className="flex" width={19.393} height={19.395}/>
              <p className='text-[12px] font-bold leading-[30px] text-[#64A4FF]'>Whatsapp</p>
            </div>
          </div>
        </div>
