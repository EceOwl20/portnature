...
const AllInclusive = ({images=[], header,span,text1,text2,starNum,carouselHeader, carouselText, carouselSpan}) => {
  return (
    <main className='flex flex-col w-screen h-auto font-lora items-center justify-center py-[150px]'>
      <div className='flex flex-col gap-[21px] items-center justify-center text-center w-[93%] lg:w-[70%] text-[#233038CC]'>
        <h2 className='text-[25px] lg:text-[35px] italic font-medium leading-[34px] lg:leading-normal'>{header}</h2>
        <p className='text-[18px] lg:text-[20px] leading-[27px] lg:leading-normal font-monserrat font-bold '>{span}</p>
      ...
      <div className='flex flex-col-reverse lg:flex-row w-full items-center leading-normal font-medium gap-[2%]'>
        <div className='flex text-start justify-start lg:justify-end lg:items-end items-center w-[86%] lg:w-[49%]'>
          ...
          <h3 className='text-[25px] lg:text-[28px] text-[#233038] leading-[32px] lg:leading-normal'>{carouselHeader}</h3>
          ...
          <UnderLine/>
          <span className='text-[#515961] text-[15px] leading-[22.5px] font-bold'>{carouselSpan}</span>
          </div>
        </div>
