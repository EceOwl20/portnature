...
const Reservation = () => {
  ...
  return (
    <div className='flex w-screen h-[300px] items-center justify-center bg-[#ffffff] '>
      <div className='lg:flex lg:flex-row grid grid-cols-2 w-[90%] lg:w-[80%] items-center justify-center text-[#233038] font-monserrat font-light text-[15px] lg:text-[20px] leading-normal text-center my-[100px]'>
          {/* Check-In Input */}
        ...
        <div className="relative flex items-center justify-center w-full lg:w-auto ">
         ...
         <div className="relative">
          ...
          {showGuests && (
            <div className="absolute top-full left-0 mt-2 bg-white border border-gray-300 text-[#233038] text-[14px] font-semibold rounded-lg shadow-lg w-full min-w-[180px] p-3 xl:p-4 ">
