...
const FooterData = ({image, image2}) => {
  return (
    <footer className='flex flex-col w-full min-h-[1198px] lg:min-h-[440px] lg:max-h-[490px] bg-center bg-cover relative items-center justify-start' style={{ backgroundImage: `url(${image.firebaseUrl})` }}>
