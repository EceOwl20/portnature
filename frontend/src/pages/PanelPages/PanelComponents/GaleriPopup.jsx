...
const GaleriPopup = ({ isModalOpen, handleModalToggle, onImageSelect,searchResults }) => {
  ...
  return (
    ...
    >
      <div
        ...
        onClick={(e) => e.stopPropagation()} // Tıklama olayını durdurur
      >
        <button
            ...
            {images.map((image, index) => (
              <div
                ...
                onClick={() => {
                  ...
                  // onImageSelect(image); // Resmi seçtiğimizde callback'i çağırıyoruz
                  // handleModalToggle(); // Popup'ı kapatıyoruz
                }}
              >
                <img
