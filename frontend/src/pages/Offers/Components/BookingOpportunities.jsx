      ...
      <div className='flex flex-col w-[90%] items-center justify-center gap-[5%] text-center h-[85%]'>
        ...
        <div className='flex flex-col lg:flex-row items-center justify-around w-full'>
            {images.map((image,index) => (
                <div className='flex flex-col gap-[30px] items-start justify-center text-start'>
                    <img src={image} width={image.width} height={image.height} className='flex max-w-[513px] max-h-[511px]'/>
