  ...
  return (
    <div className='flex w-screen items-center justify-center my-20 md:my-[150px]'>
      ...
      <div className='flex w-[90%] md:w-[85%] items-center justify-between md:justify-around relative'>
        ...
        <img src={images[0].firebaseUrl} className="hidden md:flex z-10" width={353} height={200}/>
        <img src={images[0].firebaseUrl} className="flex md:hidden z-10" width={269} height={150}/>
        ...
        <img src={images[1].firebaseUrl} className="hidden md:flex" width={166} height={148}/>
        ...
        <img src={images[5].firebaseUrl} className="hidden md:flex absolute -top-[20%] right-[20%]" width={272} height={86}/>
        <img src={images[6].firebaseUrl} className="absolute top-[50%] left-[5%] md:left-[10%] z-50" width={54} height={116}/>
        <img src={images[7].firebaseUrl} className="hidden md:flex absolute -top-[35%] left-[25%]" width={71.307} height={53.156}/>
        <img src={images[8].firebaseUrl} className="hidden md:flex absolute -top-[35%] right-[35%]" width={65} height={23}/>
        <img src={images[9].firebaseUrl} className="hidden md:flex absolute -top-[45%] right-[40%]" width={46} height={18}/>
        <img src={images[10].firebaseUrl} className="absolute -top-[60%] right-[15%]" width={64} height={58}/>
        <img src={images[10].firebaseUrl} className="hidden md:flex absolute -top-[60%] right-[15%]" width={64} height={58}/>
        <img src={images[11].firebaseUrl} className="absolute -top-[45%] right-[1%]" width={192} height={187}/>
        <img src={images[12].firebaseUrl} className="hidden md:flex absolute top-[55%] right-[4%]" width={32} height={35}/>
      </div>
      </div>
    </div>
  )
