...
const SubroomsInfoSection = ({text,items,images}) => {
  return (
    <div className='flex flex-col w-screen h-auto my-12 justify-center items-center '>
      ...
      <div className='flex flex-col lg:grid lg:grid-cols-2 w-[100%] md:w-[90%] lg:w-[85%] gap-[30px]'>
        {images.map((image, index) => (
          <img key={index} src={image} alt='familyroom' width={image.width} height={image.height} />
        ))}
        <div className='flex flex-col w-[98%] items-center lg:items-start justify-center text-center lg:text-start gap-4 text-[13px] lg:text-[15px] text-black font-monserrat font-normal leading-[19px] lg:leading-[22.5px]'>
