...
const MeetingReverseSection = ({image,header,text,span}) => {
  return (
    <div id='perge' className='flex w-full justify-center items-center my-12'>
      <div className='flex flex-col lg:flex-row-reverse w-[90%] justify-between items-center'>
        ...
        <div className='flex flex-col lg:w-[35%] items-center lg:items-end justify-center lg:justify-start text-center lg:text-start'>
           <div className='w-[85%] lg:w-[70%] flex flex-col gap-[30px] mt-4'>
