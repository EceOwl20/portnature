...
const MeetingSection = ({image,header,text,span}) => {
  return (
    <div id='thermesos' className='flex w-full justify-center items-center my-12'>
      <div className='flex flex-col lg:flex-row w-[90%] justify-between items-center'>
        ...
        <div className='flex flex-col lg:w-[35%] items-center lg:items-start justify-center lg:justify-start text-center lg:text-start '>
           <div className='w-[85%] lg:w-[70%] flex flex-col gap-5 lg:gap-[30px] mt-4'>
